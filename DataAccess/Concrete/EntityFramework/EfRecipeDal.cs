...
{
    public class EfRecipeDal : EfEntityRepositoryBase<RecipeObject, NorthwindContext>, IRecipeDal
    {
        ...
        public List<RecipeObject> GetRecipeDetails()
        {
            using (NorthwindContext context = new NorthwindContext())
            {
                ...
                //             join r in context.RecipeIngredientRelation
                //                on p.Id equals r.RecipeId
                //             join i in context.Ingredients
                //                 on r.IngredientId equals i.Id
